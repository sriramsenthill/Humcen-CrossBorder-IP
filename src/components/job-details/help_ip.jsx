        ...
        <div className="ac-chose-area mb-130">
          <div className="container">
            ...
            <div className='d-flex m-0' style={{width:'100%'}}>
              <ChoseItem duration='.3s' delay='.5s' icon='flaticon-group' title={<>Boost Your IP Expertise</>}
                text={'24+ Team Member'} listItems={innovatorsList}/>
              <ChoseItem duration='.5s' delay='.7s' item_num={'tpchosebox-three'} color="fea-color-5" icon='fas fa-star' title={<>Streamlined IP Portfolio Management </>} text={'100% Client Satisfied'} listItems={businessList} />
              <ChoseItem duration='.7s' delay='.9s' item_num={'tpchosebox-two'} color="fea-color-4" icon='flaticon-web' title={<>Monetize IP Strategies </>} text={'65.04 k Reach'} listItems={ipList} />
          </div>
          </div>
        </div>
        </div>
