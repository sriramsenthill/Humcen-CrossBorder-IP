...
const WhatWeDo = () => {
  ...
  return (
       <div className=" ac-chose-bg3 mb-50">
        <div className="row">
        <div className="col-xl-5 col-lg-5 wow tpfadeLeft" data-wow-duration=".5s" data-wow-delay=".5s" style={{ paddingRight: "20px" }}>
      <div className="tp-fea-img col-12 d-lg-block" style={{ marginLeft: "-308px" , width: isMobile ? "420px" : "170%", height: "auto", marginTop:"-10px", position: "relative", left: isMobile && "60%"}}>
       <img src={tabImage} alt="" className='ml-40 mr-100 mt-0 mb-30' />
          ...
          <div className="sd-service-details-paragraph">
                 <h3 className="tp-title-sm service-details-space center mb-0 mt-140" style={{marginTop: isMobile && "15px"}}>What <span style={{background: 'linear-gradient(270deg, #02E1B9 0%, #00ACF6 100%)',color: 'transparent',WebkitBackgroundClip: 'text',}} >We Do</span></h3>
